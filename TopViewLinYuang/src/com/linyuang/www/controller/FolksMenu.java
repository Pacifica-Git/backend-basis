...
/**
 *@Auther Yuang
 *@Description //TODO 所有瓜展示界面中，点击一行，可以显示一个瓜
 *@Param [stage, scrollPane, vBox, melons]
 *@return void
**/

    public static void generateMelons(Stage stage, ScrollPane scrollPane, VBox vBox, ArrayList<Melon> melons) {
       // AdminMenu.generateListview(stage, scrollPane, vBox, melons, flowPane1);
    }
