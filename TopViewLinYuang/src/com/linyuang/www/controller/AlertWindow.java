...
**/
    ...
    public static void alertMelon(ArrayList<Melon> melons){
        ...
        Button buttonModify = new Button("修改"),buttonLike = new Button("点赞"),buttonReport = new Button("举报");
        ...
        buttonModify.setOnMouseClicked(e->{
            ...
            if(Service.modifyCheckSenter(melon.getMelonId())){
                ...
                buttonModify.setOnMouseClicked(e1->{
                    ...
                    textArea1.setEditable(false);
                    Service.modifyMelon(melon.getMelonId(),melon.getTitle(),textArea1.getText(),melon.getHotDegree(),melon.getBelongCircleId(),melon.getPostTime(),melon.getMelonSenterId());
                    stage.close();
                });
            }
        });
        ...
        HBox hBox1 = new HBox();
        hBox1.getChildren().addAll(buttonModify,empty1,buttonLike,empty2,buttonReport);
    ...
    **/
    ...
    public static void alertReport(int melonId,String melonText){
        ...
        button.setOnMouseClicked(e->{
            ...
            if(!CheckValidReport.checkValidReport(textArea.getText())){
